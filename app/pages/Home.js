          ...
          <View style={styles.headerContainer}>
            ...
            <View style={styles.container}>
              ...
              <ScrollableTabView
                ...
                renderTabBar={() => <ScrollableTabBar style={{borderBottomWidth: 0, paddingBottom: 5, width: screenWidth*.9, height: 45, elevation: 2}}/>} 
                tabBarPosition='top' 
                onChangeTab={(obj) => {console.log('current index: ')}}
                onScroll={(position) => {console.log('%o', position)}}
                locked={false} 
                initialPage={0}
